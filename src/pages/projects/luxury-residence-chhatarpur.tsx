...
export default function LuxuryResidenceChhatarpur() {
  ...
  return (
    <>
      <Helmet>
        <title>Luxury Residence in Chhatarpur | Sattva Design Projects</title>
        <meta 
          name="description" 
          content="Discover our luxury residential project in Chhatarpur, featuring contemporary architecture, sustainable design, and modern living spaces."
        />
        <meta 
          name="keywords" 
          content="luxury residence, Chhatarpur, residential architecture, modern home, sustainable design, Sattva Design"
        />
