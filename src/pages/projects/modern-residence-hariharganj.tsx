...
export default function ModernResidenceHariharganj() {
  ...
  return (
    <>
      <Helmet>
        <title>Modern Residence in Hariharganj | Sattva Design Projects</title>
        <meta 
          name="description" 
          content="Discover our modern residential project in Hariharganj, featuring contemporary design, sustainable architecture, and innovative living spaces."
        />
        <meta 
          name="keywords" 
          content="modern residence, Hariharganj, residential architecture, contemporary home, sustainable design, Sattva Design"
        />
