...
export default function NawaBazar() {
  ...
  const localBusinessSchema = {
    ...
    "url": "https://sattvadesign.in/service-areas/nawa-bazar",
  ...
  return (
    <>
      <Helmet>
        <title>Sattva Design - Premier Architecture & Interior Design in Nawa Bazar</title>
        <meta 
          name="description" 
          content="Transform your space with Sattva Design's expert architectural and interior design services in Nawa Bazar. Specializing in sustainable, modern design solutions. Contact us for a consultation."
        />
        <meta 
          name="keywords" 
          content="architecture firm Nawa Bazar, interior design Nawa Bazar, sustainable architecture, modern home design, commercial architecture, Jharkhand architects, luxury interior design, green building"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sattvadesign.in/service-areas/nawa-bazar" />
      ...
      <div className="pt-20">
            ...
            <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
              <div className="text-center text-white max-w-4xl px-4">
                <h1 className="text-4xl md:text-6xl font-serif mb-6">
                  Design Excellence in Nawa Bazar
                </h1>
                <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
                  Creating sustainable spaces that blend tradition with modernity
                </p>
                <a 
                  href="#contact"
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-serif mb-6">About Nawa Bazar</h2>
              <p className="text-gray-600 text-lg">
                Nawa Bazar, a bustling commercial center in Jharkhand's Palamu region, 
                embodies the spirit of entrepreneurship and community development. As a 
                key trading hub, the area combines traditional market culture with modern 
                business practices. At Sattva Design, we understand this dynamic 
                environment and create architectural solutions that support both commerce 
                and community life. Our designs incorporate elements that enhance business 
                functionality while maintaining the area's historic character. We focus on 
                developing spaces that not only serve commercial needs but also contribute 
                to the area's sustainable growth and cultural preservation.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-serif mb-6">Transforming Nawa Bazar's Architectural Landscape</h2>
              <p className="text-gray-600 text-lg">
                ...
                international expertise with deep local understanding to every project in Nawa Bazar.
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-8">Areas We Serve in Nawa Bazar</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h3 className="text-xl font-serif mb-4">Central Nawa Bazar</h3>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-12 text-center">Our Work in Nawa Bazar</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group relative overflow-hidden rounded-lg">
                <img 
                  src="https://images.unsplash.com/photo-1600607687644-c7171b42498f"
                  alt="Modern Commercial Complex in Nawa Bazar"
                  className="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="text-white text-center p-6">
                    <h3 className="text-xl font-serif mb-2">Commercial Complex</h3>
                    <p className="text-sm mb-4">Modern commercial design in Nawa Bazar</p>
                    <Link to="/projects/commercial-complex-nawa-bazar" className="text-white underline">
                      View Project
                    </Link>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <blockquote className="bg-white p-8 rounded-lg shadow-sm">
                <p className="text-gray-600 mb-4">
                  "Sattva Design exceeded our expectations with their innovative design solutions. 
                  Their understanding of local requirements and modern aesthetics is impressive."
                </p>
                <footer className="font-medium">
                  — Business Owner, Nawa Bazar
                </footer>
              </blockquote>
              <blockquote className="bg-white p-8 rounded-lg shadow-sm">
                <p className="text-gray-600 mb-4">
                  "The team at Sattva Design brought our vision to life perfectly. Their attention 
                  to detail and professional approach made the entire process smooth."
                </p>
                <footer className="font-medium">
                  — Homeowner, Nawa Bazar
                </footer>
              </blockquote>
            </div>
          </div>
