...
export default function Hariharganj() {
  ...
  const localBusinessSchema = {
    ...
    "url": "https://sattvadesign.in/service-areas/hariharganj",
  ...
  return (
    <>
      <Helmet>
        <title>Sattva Design - Premier Architecture & Interior Design in Hariharganj</title>
        <meta 
          name="description" 
          content="Transform your space with Sattva Design's expert architectural and interior design services in Hariharganj. Specializing in sustainable, modern design solutions. Contact us for a consultation."
        />
        <meta 
          name="keywords" 
          content="architecture firm Hariharganj, interior design Hariharganj, sustainable architecture, modern home design, commercial architecture, Jharkhand architects, luxury interior design, green building"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sattvadesign.in/service-areas/hariharganj" />
      ...
      <div className="pt-20">
            ...
            <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
              <div className="text-center text-white max-w-4xl px-4">
                <h1 className="text-4xl md:text-6xl font-serif mb-6">
                  Elevating Spaces in Hariharganj
                </h1>
                <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
                  Award-winning architectural design firm bringing world-class design solutions to Hariharganj
                </p>
                <a 
                  href="#contact"
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-serif mb-6">Transforming Hariharganj's Architectural Landscape</h2>
              <p className="text-gray-600 text-lg">
                ...
                international expertise with deep local understanding to every project in Hariharganj.
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-8">Areas We Serve in Hariharganj</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h3 className="text-xl font-serif mb-4">Central Hariharganj</h3>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-12 text-center">Our Work in Hariharganj</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group relative overflow-hidden rounded-lg">
                <img 
                  src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d"
                  alt="Residential Project in Hariharganj"
                  className="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="text-white text-center p-6">
                    <h3 className="text-xl font-serif mb-2">Modern Residence</h3>
                    <p className="text-sm mb-4">Contemporary residential design in Hariharganj</p>
                    <Link to="/projects/modern-residence-hariharganj" className="text-white underline">
                      View Project
                    </Link>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <blockquote className="bg-white p-8 rounded-lg shadow-sm">
                <p className="text-gray-600 mb-4">
                  "Sattva Design transformed our vision into reality. Their understanding of local 
                  architecture and modern design principles created a perfect blend for our home."
                </p>
                <footer className="font-medium">
                  — Homeowner, Hariharganj
                </footer>
              </blockquote>
              <blockquote className="bg-white p-8 rounded-lg shadow-sm">
                <p className="text-gray-600 mb-4">
                  "Working with Sattva Design was a pleasure. Their attention to detail and 
                  commitment to sustainability aligned perfectly with our values."
                </p>
                <footer className="font-medium">
                  — Business Owner, Hariharganj
                </footer>
              </blockquote>
            </div>
          </div>
