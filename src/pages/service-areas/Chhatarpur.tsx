...
export default function Chhatarpur() {
  ...
  const localBusinessSchema = {
    ...
    "url": "https://sattvadesign.in/service-areas/chhatarpur",
  ...
  return (
    <>
      <Helmet>
        <title>Sattva Design - Premier Architecture & Interior Design in Chhatarpur</title>
        <meta 
          name="description" 
          content="Transform your space with Sattva Design's expert architectural and interior design services in Chhatarpur. Specializing in sustainable, modern design solutions. Contact us for a consultation."
        />
        <meta 
          name="keywords" 
          content="architecture firm Chhatarpur, interior design Chhatarpur, sustainable architecture, modern home design, commercial architecture, Jharkhand architects, luxury interior design, green building"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sattvadesign.in/service-areas/chhatarpur" />
      ...
      <div className="pt-20">
            ...
            <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
              <div className="text-center text-white max-w-4xl px-4">
                <h1 className="text-4xl md:text-6xl font-serif mb-6">
                  Elevating Spaces in Chhatarpur
                </h1>
                <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
                  Award-winning architectural design firm bringing world-class design solutions to Chhatarpur
                </p>
                <a 
                  href="#contact"
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-serif mb-6">Transforming Chhatarpur's Architectural Landscape</h2>
              <p className="text-gray-600 text-lg">
                ...
                international expertise with deep local understanding to every project in Chhatarpur.
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-8">Areas We Serve in Chhatarpur</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h3 className="text-xl font-serif mb-4">Central Chhatarpur</h3>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-12 text-center">Our Work in Chhatarpur</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group relative overflow-hidden rounded-lg">
                <img 
                  src="https://images.unsplash.com/photo-1600585154526-990dced4db0d"
                  alt="Residential Project in Chhatarpur"
                  className="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="text-white text-center p-6">
                    <h3 className="text-xl font-serif mb-2">Luxury Residence</h3>
                    <p className="text-sm mb-4">Modern residential design in Chhatarpur</p>
                    <Link to="/projects/luxury-residence-chhatarpur" className="text-white underline">
                      View Project
                    </Link>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <blockquote className="bg-white p-8 rounded-lg shadow-sm">
                <p className="text-gray-600 mb-4">
                  "Sattva Design's innovative approach to our project was remarkable. They perfectly 
                  balanced our traditional preferences with modern design elements."
                </p>
                <footer className="font-medium">
                  — Property Developer, Chhatarpur
                </footer>
              </blockquote>
              <blockquote className="bg-white p-8 rounded-lg shadow-sm">
                <p className="text-gray-600 mb-4">
                  "The attention to detail and commitment to quality shown by the Sattva Design team 
                  made our dream home a reality."
                </p>
                <footer className="font-medium">
                  — Homeowner, Chhatarpur
                </footer>
              </blockquote>
            </div>
          </div>
