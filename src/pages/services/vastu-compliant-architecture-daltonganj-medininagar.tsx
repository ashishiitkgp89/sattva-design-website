...
const VastuCompliantArchitectureDaltonganjMedininagar: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Vastu-Compliant Architecture in Daltonganj (Medininagar) | Sattva Design</title>
        <meta 
          name="description" 
          content="Professional Vastu-compliant architectural services in Daltonganj (Medininagar). Create harmonious spaces that blend traditional wisdom with modern design."
        />
