...
export const metadata: Metadata = {
  title: { absolute: 'Designed Blueprints in Daltonganj (Medininagar) | Sattva Design' },
  description: 'Professional blueprint design services in Daltonganj (Medininagar). Detailed architectural drawings and construction documentation for your building projects.',
  alternates: { canonical: 'https://sattvadesignconsultancy.com/services/designed-blueprints-daltonganj-medininagar' },
  openGraph: {
    title: 'Designed Blueprints in Daltonganj (Medininagar) | Sattva Design',
    description: 'Professional blueprint design services in Daltonganj (Medininagar). Detailed architectural drawings and construction documentation for your building projects.',
    url: 'https://sattvadesignconsultancy.com/services/designed-blueprints-daltonganj-medininagar',
  },
};
...
const DesignedBlueprintsDaltonganjMedininagar: React.FC = () => {
  ...
  const faqs = [
    {
      q: "What is included in a blueprint package?",
      a: "A complete package usually includes detailed construction drawings, floor plans, technical specifications, and material details, all prepared to comply with local building codes and ready to hand to your contractor.",
    },
    {
      q: "How much do designed blueprints cost in Daltonganj (Medininagar)?",
      a: "Blueprint pricing depends on the size and complexity of the building and the level of detail required. We review your project and provide a transparent quote before starting the drawings.",
    },
    {
      q: "Can you revise the blueprints if my requirements change?",
      a: "Yes. We use systematic revision management to track and incorporate changes, so your drawings stay accurate and up to date as the design evolves.",
    },
    {
      q: "Why choose Sattva Design for blueprints in Medininagar?",
      a: "Based in Medininagar, we combine technical expertise with modern CAD tools to produce precise, compliant, construction-ready blueprints, ensuring your design vision is accurately represented on site.",
    },
  ];
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              <h1 className="text-4xl md:text-5xl font-serif mb-4">
                Designed Blueprints in Daltonganj (Medininagar)
              </h1>
