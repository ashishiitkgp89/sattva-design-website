...
export const metadata: Metadata = {
  title: {
    absolute: 'Retail Stores & Showrooms Design in Daltonganj (Medininagar) | Sattva Design',
  },
  description:
    'Expert retail store and showroom design services in Daltonganj (Medininagar). Create engaging commercial spaces that drive business success.',
  alternates: {
    canonical: 'https://sattvadesignconsultancy.com/services/retail-stores-showrooms-daltonganj-medininagar',
  },
  openGraph: {
    title: 'Retail Stores & Showrooms Design in Daltonganj (Medininagar) | Sattva Design',
    description:
      'Expert retail store and showroom design services in Daltonganj (Medininagar). Create engaging commercial spaces that drive business success.',
    url: 'https://sattvadesignconsultancy.com/services/retail-stores-showrooms-daltonganj-medininagar',
  },
};
...
const RetailStoresShowroomsDaltonganjMedininagar: React.FC = () => {
  ...
  const faqs = [
    {
      q: "Do you design new retail stores from scratch in Daltonganj (Medininagar)?",
      a: "Yes. We design new retail stores and showrooms end to end, from space planning and layout to fixtures, lighting, and visual merchandising, so the space is ready to perform from day one."
    },
    {
      q: "How do you make the best use of a small retail space?",
      a: "Through strategic space planning and customer flow optimisation, we arrange displays, aisles, and storage so that even a compact store feels open, shows products clearly, and uses every square foot productively."
    },
    {
      q: "Can you incorporate digital and interactive elements in the store design?",
      a: "Yes. We can plan digital integration points such as screens, billing counters, and interactive displays within the layout so technology supports the shopping experience rather than cluttering it."
    },
    {
      q: "Do your retail designs include sustainable features?",
      a: "Yes. We can incorporate sustainable design elements such as energy-efficient lighting and durable, low-maintenance materials, helping reduce running costs while keeping the store attractive."
    }
  ];
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              <h1 className="text-4xl md:text-5xl font-serif mb-4">
                Retail Stores & Showrooms Design in Daltonganj (Medininagar)
              </h1>
