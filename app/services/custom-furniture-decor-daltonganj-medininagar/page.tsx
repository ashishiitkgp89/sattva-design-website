...
export const metadata: Metadata = {
  title: { absolute: 'Custom Furniture & Décor in Daltonganj (Medininagar) | Sattva Design' },
  description: 'Professional custom furniture and décor services in Daltonganj (Medininagar). Creating unique, personalized pieces for your space.',
  alternates: { canonical: 'https://sattvadesignconsultancy.com/services/custom-furniture-decor-daltonganj-medininagar' },
  openGraph: {
    title: 'Custom Furniture & Décor in Daltonganj (Medininagar) | Sattva Design',
    description: 'Professional custom furniture and décor services in Daltonganj (Medininagar). Creating unique, personalized pieces for your space.',
    url: 'https://sattvadesignconsultancy.com/services/custom-furniture-decor-daltonganj-medininagar',
  },
};
...
const CustomFurnitureDecorDaltonganjMedininagar: React.FC = () => {
  ...
  const faqs = [
    {
      q: "How much does custom furniture cost in Daltonganj (Medininagar)?",
      a: "The price depends on the materials, dimensions, finish, and complexity of each piece. Solid wood and bespoke joinery cost more than simpler designs. We provide a per-piece quote once we understand your requirements.",
    },
    {
      q: "How long does it take to make custom furniture?",
      a: "Lead times depend on the design and the number of pieces. A single item is generally quicker than a full room set. We confirm a production schedule after the design and materials are finalised.",
    },
    {
      q: "Can you match new furniture to my existing interior style?",
      a: "Yes. We design pieces that complement your current décor, architecture, and colour scheme, so new furniture blends seamlessly rather than looking out of place.",
    },
    {
      q: "Why choose Sattva Design for custom furniture in Medininagar?",
      a: "We are a Medininagar-based design firm offering bespoke pieces crafted with quality materials and skilled workmanship. From concept to installation, we handle the entire process and style the pieces in your space.",
    },
  ];
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              <h1 className="text-4xl md:text-5xl font-serif mb-4">
                Custom Furniture & Décor in Daltonganj (Medininagar)
              </h1>
