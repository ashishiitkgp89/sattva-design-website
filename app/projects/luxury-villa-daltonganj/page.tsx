...
export const metadata: Metadata = {
  title: { absolute: 'Luxury Villa in Daltonganj | Sattva Design Projects' },
  description:
    'Explore our luxury villa project in Civil Lines, Daltonganj. A perfect blend of modern architecture, premium amenities, and sustainable design.',
  keywords:
    'luxury villa, Daltonganj, Civil Lines, residential architecture, modern home, sustainable design, Sattva Design',
  alternates: { canonical: '/projects/luxury-villa-daltonganj' },
};
