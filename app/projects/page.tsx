...
export const metadata: Metadata = {
  title: 'Our Projects',
  description:
    'Explore architecture and interior design projects by Sattva Design across Jharkhand — residential, commercial, and more.',
  alternates: { canonical: '/projects' },
  openGraph: {
    title: 'Our Projects',
    description:
      'Architecture and interior design projects by Sattva Design across Jharkhand.',
    url: '/projects',
  },
};
