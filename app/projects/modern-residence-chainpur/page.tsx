...
export const metadata: Metadata = {
  title: { absolute: 'Modern Residence in Chainpur | Sattva Design Projects' },
  description:
    'Contemporary residential project in Chainpur by Sattva Design, featuring sustainable architecture and modern amenities while respecting local cultural elements.',
  keywords:
    'modern residence, Chainpur, residential architecture, sustainable design, luxury homes, Sattva Design',
  alternates: { canonical: '/projects/modern-residence-chainpur' },
};
...
export default function ModernResidenceChainpur() {
  const projectSchema = {
    ...
    "@type": "CreativeWork",
    "name": "Modern Residence in Chainpur",
    "description": "Contemporary residential project in Chainpur featuring sustainable architecture and modern amenities while respecting local cultural elements.",
    "image": "https://images.unsplash.com/photo-1600585154340-be6161a56a0c",
    "locationCreated": { "@type": "Place", "name": "Chainpur, Jharkhand" },
    "creator": { "@id": "https://sattvadesignconsultancy.com/#organization" },
    "url": "https://sattvadesignconsultancy.com/projects/modern-residence-chainpur"
  };
