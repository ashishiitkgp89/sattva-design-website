...
export const metadata: Metadata = {
  title: {
    absolute: 'Sattva Design - Premier Architecture & Interior Design in Chhatarpur',
  },
  description:
    "Transform your space with Sattva Design's expert architectural and interior design services in Chhatarpur. Specializing in sustainable, modern design solutions. Contact us for a consultation.",
  keywords:
    'architecture firm Chhatarpur, interior design Chhatarpur, sustainable architecture, modern home design, commercial architecture, Jharkhand architects, luxury interior design, green building',
  alternates: { canonical: 'https://sattvadesignconsultancy.com/service-areas/chhatarpur' },
  openGraph: {
    title: 'Sattva Design - Premier Architecture & Interior Design in Chhatarpur',
    description:
      "Transform your space with Sattva Design's expert architectural and interior design services in Chhatarpur. Specializing in sustainable, modern design solutions. Contact us for a consultation.",
    url: 'https://sattvadesignconsultancy.com/service-areas/chhatarpur',
  },
};
...
export default function Chhatarpur() {
  ...
  const localBusinessSchema = {
    ...
    "description": "Leading architectural and interior design firm serving Chhatarpur, specializing in sustainable and modern design solutions.",
    "address": {
      "@type": "PostalAddress",
    ...
    "areaServed": { "@type": "Place", "name": "Chhatarpur" },
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'We handle custom home and villa design, commercial and retail layouts, interior design, Vastu-compliant planning, renovation and remodelling, 3D visualisation and construction management.',
    },
    {
      q: 'Can you prepare naksha and building approvals for Chhatarpur?',
      a: 'Yes. We prepare designed blueprints and estimates and assist with the naksha and building approval process required before construction can start in Chhatarpur.',
    },
    {
      q: 'How do I begin a project in Chhatarpur?',
      a: 'Contact our Medininagar office with your plot details and what you want to build. We discuss the brief, study the site, then move through design, approvals, estimation and construction.',
    },
  ];
    ...
    <>
      ...
      <div className="pt-20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">
                ...
                construction. We take each project from the first plot study and layout through the working drawings,
                building approvals and estimate, staying involved while it is built so the finished space matches what
                was drawn.
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-12 text-center">Why Choose Sattva Design in Chhatarpur?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-8 rounded-lg">
                <h3 className="text-xl font-serif mb-4">Local Expertise</h3>
                <p className="text-gray-600">
                  Deep understanding of Chhatarpur's climate, culture, and building regulations,
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-serif mb-8">How We Work on Chhatarpur Projects</h2>
